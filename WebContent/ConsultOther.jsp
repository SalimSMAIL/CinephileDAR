...
<body class="">
                  ...
                  <section class="vbox">
                    <section class="scrollable">
                      <div class="wrapper">
                        ...
                        <div>
                          <small class="text-uc text-xm text-muted" style="font-size: 16px!important;color:black">A propos de moi : </small>
                          <p id="description"></p>
                          <div class="line"></div>
                        </div>
                        <div class="btn-group btn-group-justified m-b">
                          ...
                          <a class="btn btn-dark btn-rounded" onclick="sendMessage()">
                            <i class="fa fa-comment-o" style="margin-right:10px" ></i> Envoyer message
                          </a>
                        </div>
                      </div>
                    </section>
  ...
  <script type="text/javascript" src="js/consult_other.js"></script>
</body>
</html>