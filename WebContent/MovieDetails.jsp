...
<body class="">
          ...
          <section class="vbox">
            <section class="scrollable wrapper-lg" style="padding-bottom: 0px;">
              <div class="row">
               <div class="col-sm-9">
               <div class="row">
                <h1 class="col-sm-8" class="post-title" id="movieTitle" style="margin-top:0px!important"></h1>
                <div class="text-info padder m-t-sm text-sm" style="float:left; margin-top:20px!important" id="movieRateStars" >
                             
                </div>
                <h3  class="post-title" style="margin-top:15px!important; text-align:left!important" id="movieRate"></h3>
               </div>
                
                  <div class="blog-post">                   
                    <div class="post-item">
                      <div class="post-media">
                        <img id="moviePoster" class="img-full">
                      </div>
                      <div class="caption wrapper-lg" style="padding-top:20px!important;padding-bottom:0px!important">
                        ...
                        <div class="post-sum">
                          <p id="movieSynopsis" style="text-align:justify" ></p>
                        </div>
                     ...
                     <h3 style="padding-top:0px!important; padding-bottom:0px!important">Cast</h3></div>
                      ...
                      <div class="caption wrapper-lg"  style="padding-top:0px!important; font-size:18px" >
                   		  <i class="fa fa-clock-o"></i> Date de sortie : <span id="movieReleased" style="color:#336e7b" ></span>
                      </div>
				...
				<h4>Bande annonce</h4>
                <div style="margin-right:20px!important" id="movieTrailer">
	                
				</div>
				
				 <div></div>
                  <h4>Suggestions</h4>
                  <div id="suggestions_movie">
                  </div>
                  ...
                  <form>
					...
					<div style="margin-top:20px"><p style="display:none" id="added">Ce film a été ajouté dans votre liste</p></div>                    
                    </div>
              ...
              <h4 class="m-t-lg m-b" id="comments_total"></h4>
                  <section class="comment-list block" id="movie_comments" >
                  </section>
  ...
  <script src="js/details_movie.js"></script>
</body>
</html>