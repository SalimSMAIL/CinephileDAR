...
<body class="">
          ...
          <section class="hbox stretch">
            <section>
             ...
             <div class="row">
                    ...
                    <div class="col-md-12">
                      <h2 class="font-thin"id="nom_list"></h2>
                      <div class="list-group bg-white list-group-lg no-bg auto" id="elements">                          
                     </div>
                    </div>
                  </div>
            </div>
  ...
  <script src="js/list_elements.js" type="text/javascript"></script>
</body>
</html>