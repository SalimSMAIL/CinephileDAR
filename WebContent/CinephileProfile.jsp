                ...
                <aside class="aside-lg bg-light lter b-r">
                  <section class="vbox">
                    <section class="scrollable">
                      <div class="wrapper">
                        <div class="text-center m-b m-t">
                          ...
                          <div>
                            ...
                            <i class="icon-user icon" style="margin-right:10px;"></i><small id="username" style="font-size: 16px!important" class="text-muted"></small><br/>
                            <i class="icon-envelope-letter icon" style="margin-right:10px;"></i><small id="email" style="font-size: 16px!important" class="text-muted"></small><br/>
                            <i class="fa fa-map-marker" style="margin-right:10px"></i><small id="address" style="font-size: 16px!important" class="text-muted"></small>
                          </div>                
                        </div>
                        <div>
                          <small class="text-uc text-xm text-muted" style="color:black; font-size: 16px!important">A propos de moi : </small>
                          <p id="description"></p>
                          <div class="line"></div>
                        </div>
                        <div class="btn-group btn-group-justified m-b">
                          <a class="btn btn-success btn-rounded" href="UpdateProfile.jsp">
                      ...
                      <form class="bs-example form-horizontal" id="FormAddList" style="display:none">
                      <div class="col-sm-12">
                        <div class="form-group">
                         
                          <div class="col-lg-11">
                            <input type="text" class="form-control" placeholder="Entre le nom de la liste" id="name" name="name">
                          </div>
                        </div>
                         <div class="form-group">
                         <div class="col-sm-2"></div>
                          <div class="col-sm-4">
                            <button type="submit" onclick="addList();return false;"class="btn btn-sm btn-default">Ajouter la liste</button>
                          </div>
                        </div>
                    ...
                    <footer class="panel-footer bg-info text-center">
                      ...
                      <div class="col-xs-2">
                        ...
                        <div class="col-xs-4" style="background-color:#4cb6cb">
                          <a style="cursor:pointer"onclick="displayFormAddList(); return false;"><div class="padder-v">
                        ...
                        <div class="col-xs-4 dk">
                          <a href="CreateEvent.html"><div class="padder-v" style="cursor:pointer">
                  ...
                  <section class="vbox">
                    <header class="header bg-light lt">
                      <ul class="nav nav-tabs nav-white">
                        ...
                        <li class=""><a href="#events" data-toggle="tab">Events que j'organise</a></li>
                    ...
                    <section class="scrollable">
                      <div class="tab-content">
                        <div class="tab-pane active" id="activity">
                          <ul class="list-group no-radius m-b-none m-t-n-xxs list-group-lg no-border" id="lists">
                          </ul>
                        </div>
